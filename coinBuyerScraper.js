...
async function getAllCoins(client){
    ...
    let index = 1;
    while(1){
        const resp = await client.get(`https://www.dextools.io/shared/analytics/pairs/gainers?limit=51&interval=24h&page=${index}&chain=avalanche&minFdv=500000&creationLowerTimeRange=7776000000&creationTimeSince=2592000000`, {
            headers: {
                "Accept": "application/json",
                "Content-Type": "application/json",
                "Referer": "https://www.dextools.io/app/en/avalanche/gainers"
            }
        })
        if(resp.body.data){
...
async function getFirstBuyersForCoin(client, pairAddress){
    let resp
    try{
        resp = await client.get(`https://www.dextools.io/shared/data/swaps?chain=avalanche&pair=${pairAddress}&ts=1702993532&filter=true`, {
            headers: {
                "Accept": "application/json",
                "Content-Type": "application/json",
                "Referer": "https://www.dextools.io/app/en/avalanche/gainers"
